...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-green-800 to-emerald-900 flex items-center justify-center relative overflow-hidden">
      ...
      <FlotingShape color="bg-green-400" size="w-64 h-64" top="-5%" left="10%" delay={0} />
      <FlotingShape color="bg-green-400" size="w-48 h-48" top="40%" left="60%" delay={5} />
      <FlotingShape color="bg-green-400" size="w-32 h-32" top="50%" left="5%" delay={2} />
    </div>
  )
}
